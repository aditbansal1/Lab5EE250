...
def main():
    ...
    locations = ['bedroom', 'living room', 'kitchen', 'hallway', 'bathroom']
    ...
    for location in locations:
        ...
        signal_strength_std = np.std(signal_strengths, ddof=1)
    ...
    fig = px.bar(
        ...
        labels={'location': 'Location', 'signal_strength_mean': 'Signal Strength (dBm)', 'signal_strength_std': 'Standard Deviation'},
        text='signal_strength_mean',
        text_auto=True,
    )
